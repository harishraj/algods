...
public class SubsetSum {
	...
	public static boolean isSubsetSum(int[] s, int n, int sum) {
		...
		// include the last element in the search - exclude last element from
		// search
	...
	public static void main(String[] args) {
		...
		System.out.println("Maximum Obtainable Value is: "
				+ isSubsetSum(arr, arr.length, 9));
		System.out.println("Maximum Obtainable Value is: "
				+ isSubsetSumDP(arr, arr.length, 9));
	}

	/**
	 * Solves the subset sum problem using a dynamic programming approach. The
