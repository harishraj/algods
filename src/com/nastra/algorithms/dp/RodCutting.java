...
public class RodCutting {
	...
	/**
	 * Naive, recursive solution where subproblems are calculated over and over
	 * again. The time complexity is O(2^n) because subproblems are solved over
	 * and over again and because we have the number of possible recursive tree
	 * nodes is 2^n-1.
	 * 
	 * @param price
	 * @param n
	...
	/**
	 * Uses a dynamic programming approach. The time complexity of this solution
	 * is O(n^2) because each subproblem is solved exactly once.
	 * 
	 * @param price
	 * @param n
	 * @return
