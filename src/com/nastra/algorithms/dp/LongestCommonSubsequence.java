 ...
 * “abc”, “bcd”, “bdf”, “aeg”, ‘”acefg”, .. etc are subsequences of “abcdefg”.
 * 
 * @see http://www.geeksforgeeks.org/dynamic-programming-set-4-longest-common-
 *      subsequence/
 * 
 * @author nastra
 * 
...
public class LongestCommonSubsequence {
	/**
	 * Algorithm runs in time O(2^n) in the worst case (when all characters
	 * mismatch) due to overlapping subproblems.
	 * 
	 * @param a
	 *            The first string
	 * @param b
	 ...
	 * @return The length of the longest common subsequence of the strings a and
	 *         b.
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("Length of LCS is: "
				+ lcs(a, b, a.length - 1, b.length - 1));
		System.out.println("Length of LCS using DP is: "
				+ lcsDP(a, b, a.length - 1, b.length - 1));
	...
	/**
	 * The dynamic programming version runs in time O(m*n) and requires O(m*n)
	 * memory, which is much better than the worst case time complexity of Naive
