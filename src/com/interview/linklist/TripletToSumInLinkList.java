...
/**
 * http://www.geeksforgeeks.org/find-a-triplet-from-three-linked-lists-with-sum-
 * equal-to-a-given-number/ Test case empty list list with 0 1 or more nodes
 * negative sum 0 sum positive sum
 */
		...
		while (head1 != null) {
			...
			while (tempHead2 != null && tempHead3 != null) {
				if (tempHead2.data + tempHead3.data == newSum) {
					System.out.println(head1.data + " " + tempHead2.data + " "
							+ tempHead3.data);
					break;
