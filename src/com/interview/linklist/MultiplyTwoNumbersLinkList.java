...
/**
 * Multiply two numbers in form of link list Idea is to multiply one number from
 * head2 with all numbers from head1. This result is stored in currentResult.
 * Pass this currentResult and any previous result from multiplication and add
 * them
 */
