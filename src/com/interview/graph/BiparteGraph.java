...
/**
 * http://www.geeksforgeeks.org/bipartite-graph/ Includes both DFS and BFS
 * method
 */
public class BiparteGraph {
	...
	private boolean isBiparteDFS(Vertex<Integer> vertex,
			Set<Vertex<Integer>> redSet, Set<Vertex<Integer>> blueSet,
			boolean wasRed) {
