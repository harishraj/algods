...
public class GraphColoring {
	...
	public void WelshPowell() {
		...
		while (sortedSet.size() != removeSet.size()) {
			...
			for (Vertex<Integer> v : sortedSet) {
				...
				boolean allUncolored = allAdjacentUnColored(
						v.getAdjacentVertexes(), assignedColor);
				if (allUncolored) {
	...
	private boolean allAdjacentUnColored(Collection<Vertex<Integer>> vertexes,
			Map<Long, String> colorsAssigned) {
