...
/**
 * http://www.glassdoor.com/Interview/Create-an-iterator-to-traverse-a-binary-
 * tree
 * -When-the-next-function-is-called-on-the-binary-tree-return-the-value-at-the
 * -QTN_674695.htm null tree.
 */
public class NextInorderSuccessorIterator {
	...
	public static void main(String args[]) {
		...
		NextInorderSuccessorIterator nis = new NextInorderSuccessorIterator(
				node);
		while (nis.hasNext()) {
