...
/**
 * http://www.geeksforgeeks.org/check-for-identical-bsts-without-building-the-
 * trees/ Test cases Both array should be same size and have exact same elements
 * and first element should be same
 */
public class IdenticalTrees {
	...
	private boolean sameBST(int tree1[], int tree2[], int min, int max,
			int index) {
		...
		boolean r1 = tree1[bs1.big] == tree2[bs2.big]
				&& tree1[bs1.small] == tree2[bs2.small];
		if (r1 == false) {
			return false;
		}
