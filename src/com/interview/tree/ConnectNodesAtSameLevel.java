 ...
 * Test cases Empty tree tree with only right childs tree with only left child
 * Tree with short left and long right side Tree with long left and short right
 * side
 */
