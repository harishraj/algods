...
public class TwoStringInterleavingToFormThird {
	...
	public boolean isInterleavedRecursive(char str1[], char str2[],
		...
		return (pos1 < str1.length && str1[pos1] == str3[pos3] && isInterleavedRecursive(
				str1, str2, str3, pos1 + 1, pos2, pos3 + 1))
				|| (pos2 < str2.length && str2[pos2] == str3[pos3] && isInterleavedRecursive(
						str1, str2, str3, pos1, pos2 + 1, pos3 + 1));
