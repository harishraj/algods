 ...
 * different ways of scoring (e.g. 3, 5 and 10 points). test case what happens
 * if total can't be formed with given values what if numbers are 0 or negative
 */
public class NumberOfWaysToScorePoints {
	...
	// This is same as fibo series only that fibo series looks at last 2 numbers
	// and here we look back k values
