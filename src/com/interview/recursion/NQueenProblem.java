...
/**
 * http://www.geeksforgeeks.org/category/c-programs/page/7/ diag is of lenght
 * 2n-1. It starts from 00 - 01 10 - 02 11 20 - 12 21 - 22 diag1 is also of
 * length 2n-1. It starts from 02 - 01 12 - 00 11 22 - 10 21 - 20 . The trick is
 * to convert column into n-1 -j so treat columns from right to left instead of
 * left to right as we do in normal case.
 */
