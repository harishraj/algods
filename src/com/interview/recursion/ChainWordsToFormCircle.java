 ...
 * form-circle/ Test cases: Empty input 1 element in input no chain formed chain
 * formed
 */
public class ChainWordsToFormCircle {
	...
	public List<String> formCircle(String input[]) {
		...
		// since chain is a circle any point can be the start point of the
		// chain.
	...
	// we keep track of first char of the chain and the end compare that with
	// last char of last element of the chain
	private boolean formCircle(String input[], List<String> result,
			boolean used[], char firstChar) {
	...
	public static void main(String args[]) {
		String notChaininput[] = { "geeks", "king", "seeks", "sing", "gik",
				"kin" };
