...
/**
 * http://www.careercup.com/question?id=6139456847347712 Test case : 0 or
 * negative number
 */
public class ConvertNumberIntoBase26 {

	/**
	 * Here 1..26 is A...Z 27...52 is AA...AZ. So we first try to divide num by
	 * 26 then find ceiling...so 27...52 returns 2. Then we subtract 1 from the
	 * number
	 * 
	 * @param num
	 * @return
