...
public class WildCardSearch {
	...
	private boolean searchStar(char mainStr[], char pattern[], int pos1,
			int pos2) {
		...
		if (pattern[pos2] == '*') {
			boolean result = searchStar(mainStr, pattern, pos1, pos2 + 1)
					|| searchStar(mainStr, pattern, pos1 + 1, pos2);
			if (result) {
				return true;
			}
		}
	...
	public static void main(String args[]) {
		...
		System.out.println(psw.searchStar(str.toCharArray(),
				pattern.toCharArray()));
	}
}
