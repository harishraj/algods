...
/**
 * http://www.geeksforgeeks.org/a-linked-list-with-next-and-arbit-pointer/ Empty
 * list 1 or more nodes list
 */
public class CopyLinkListWIthArbitPointer {
	...
	public Node copy(Node head) {
		...
		Node current = head;
		// create new node with same value as current and insert it after
		// current
		while (current != null) {
