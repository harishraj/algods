...
public class OneEditApart {
	...
	private boolean match(char[] str1, char[] str2, int pos1, int pos2,
			boolean areSame) {
		...
		if (areSame) {
			return match(str1, str2, pos1 + 1, pos2 + 1,
					str1[pos1] == str2[pos2])
					|| match(str1, str2, pos1, pos2 + 1, false)
					|| match(str1, str2, pos1 + 1, pos2, false);
		} else {
			return str1[pos1] == str2[pos2]
					&& match(str1, str2, pos1 + 1, pos2 + 1, areSame);
		}
	}
	...
	public static void main(String args[]) {
		...
		System.out.println(oea.matchRecurisve("cat".toCharArray(),
				"dog".toCharArray()));
		System.out.println(oea.matchRecurisve("cat".toCharArray(),
				"cats".toCharArray()));
		System.out.println(oea.matchRecurisve("cat".toCharArray(),
				"cut".toCharArray()));
		System.out.println(oea.matchRecurisve("cats".toCharArray(),
				"casts".toCharArray()));
		System.out.println(oea.matchRecurisve("cats".toCharArray(),
				"acts".toCharArray()));

		System.out.println(oea.matchIterative("cat".toCharArray(),
				"dog".toCharArray()));
		System.out.println(oea.matchIterative("cat".toCharArray(),
				"cats".toCharArray()));
		System.out.println(oea.matchIterative("cat".toCharArray(),
				"cut".toCharArray()));
		System.out.println(oea.matchIterative("cats".toCharArray(),
				"casts".toCharArray()));
		System.out.println(oea.matchIterative("cats".toCharArray(),
				"acts".toCharArray()));
	}
