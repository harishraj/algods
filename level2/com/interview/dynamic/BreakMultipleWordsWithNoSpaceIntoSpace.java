...
public class BreakMultipleWordsWithNoSpaceIntoSpace {
	...
	/**
	 * Easier implementation to understand Gives preference to longer words over
	 * splits e.g peanutbutter with dict{pea nut butter peanut} it would result
	 * in peanut butter instead of pea nut butter. Above method does the
	 * opposite
	 * 
	 * @return
	 */
