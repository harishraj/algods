 ...
 * 
 * The idea is that to calculate for i all you have to do is add up i-1 values
 * of all the neighbors. e.g for i =2 and at 0 you need find i=1s of all
 * neighbors including 0 and add them up.
 */
