...
/**
 * http://www.geeksforgeeks.org/diameter-of-a-binary-tree/ Test cases All left
 * nodes All right nodes
 */
public class DiameterOfTree {
	...
	private int diameter(Node root, Height height) {
		...
		return Math.max(Math.max(dial, diar),
				(1 + leftHeight.height + rightHeight.height));
	}
